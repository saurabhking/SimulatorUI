...
counter = 0
#server_addr="rdc1-vip.enwd.co.sc.charterlab.com"
server_port=10101
BUFFER_SIZE = 20
s = ''
...
def init():
	...
	s.connect((settings.lsc_host, server_port))
...
def lscplay():
	...
	LSCSTR = LSC1 + LSC_TCODE + LSC_OPCODE + settings.Stream_handle + LSC2 
	#print "In LSC PLAY"
	#print LSCSTR
	initSettingsValue()
...
def lscstatus():
	...
	LSC_TCODE = format(counter,'02x')
	LSC_OPCODE = '0300'
	LSCSTR = LSC1 + LSC_TCODE + LSC_OPCODE + settings.Stream_handle
	#print "In LSC STATUS"
